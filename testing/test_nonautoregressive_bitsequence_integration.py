"""Integration tests for NonAutoregressiveBitSequence environment.

Mirrors the tests in test_adaptor_estimator_gflownet_integration.py
for the autoregressive BitSequence environment.
"""
...
def _make_recurrent_pf(
    env: NonAutoregressiveBitSequence, device: torch.device
) -> RecurrentDiscretePolicyEstimator:
...
def _make_nonrecurrent_pf_pb(env: NonAutoregressiveBitSequence, device: torch.device):
