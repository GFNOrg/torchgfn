...
class HyperGrid(DiscreteEnv):
    ...
    def get_states_indices(self, states: DiscreteStates) -> TT["batch_shape", torch.long]:
    ...
    def get_terminating_states_indices(self, states: DiscreteStates) -> TT["batch_shape", torch.long]:
