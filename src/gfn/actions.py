...
class Actions(ABC):
    ...
    def __init__(self, tensor: TensorType["batch_shape", "action_shape"]):
    ...
    @property
    def is_dummy(self) -> TensorType["batch_shape", torch.bool]:
    ...
    @property
    def is_exit(self) -> TensorType["batch_shape", torch.bool]:
