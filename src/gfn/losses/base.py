...
class TrajectoryDecomposableLoss(Loss, ABC):
    def get_pfs_and_pbs(
        ...
        Returns:
            Tuple[LogPTrajectoriesTensor, LogPTrajectoriesTensor]: A tuple of float tensors of shape (max_length, n_trajectories) containing the log_pf and log_pb for each action in each trajectory.
        """
