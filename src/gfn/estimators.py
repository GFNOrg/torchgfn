...
class DiscreteGraphPolicyEstimator(LogitBasedEstimator):
    ...
    def to_probability_distribution(
        ...
        no_possible_add_node = no_possible_node_index if self.is_backward else no_possible_node_class
        ...
        return GraphActionDistribution(logits=TensorDict(transformed_logits), is_backward=self.is_backward)
